...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Poisson regression problem"
    )
    parser.add_argument(
        "--epochs",
        type=int,
    ...
    parser.add_argument(
        "--results-path",
        type=str,
        default='results/poisson/',
        help="Path to results (default: results/poisson/)",
    )
    parser.add_argument(
        "--model-path",
        type=str,
        default="models/poisson/",
        help="Path to model file (default: models/poisson/)",
    )
    parser.add_argument(
        "--file-name",
        type=str,
        default="poisson",
        help="Name of output files (default: poisson)",
    )
    parser.add_argument(
        "--lr",
        type=float,
