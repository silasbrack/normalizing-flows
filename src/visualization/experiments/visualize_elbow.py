...
ax.set(title="Posterior samples at \n iteration 5000", xlabel=None, ylabel=None, xticks=[], yticks=[], xticklabels=[], yticklabels=[], xlim=[-4,4], ylim=[-4,4])
...
ax.set(title="Posterior samples at \n iteration 6000", xlabel=None, ylabel=None, xticks=[], yticks=[], xticklabels=[], yticklabels=[], xlim=[-4,4], ylim=[-4,4])
# ax.get_legend().remove()
